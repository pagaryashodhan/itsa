  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="container event-body">
        <div className="row">
          <h2 style={{textalign: "center"}} data-aos="fade-up">Upcoming Events</h2>
        </div>
        <div className="row justify-content-evenly mt-2 event-list">
          <div className="card card-1" data-aos="fade-right" style={{width: "18rem"}}>
            <img
            ...
            <div className="card-body">
              <div className="card-timer">
                <div className="">
                  <i className="bi bi-currency-rupee"></i> <span> Rs. 1000</span>
                </div>
                <div className="">
              ...
              <a href="u" className="btn btn-primary">Register</a>
            </div>
          </div>

         

          <div className="card card-2" data-aos="fade-up" style={{width: "18rem"}}>
            <img
              className="card-img-top bg-light"
              width="300"
              height="150"
            ...
            <div className="card-body">
              ...
              <a href="u" className="btn btn-light">Register</a>
            </div>
          </div>

          <div className="card card-3" data-aos="fade-left" style={{width: "18rem"}}>
            <img
              className="card-img-top bg-light"
              width="300"
              height="150"
      ...
      <div className="container event-body">
        ...
        <div className="row">
          <h2 style={{textalign: "center"}} data-aos="fade-up">Past Events</h2>
        </div>
        <div className="row justify-content-evenly mt-2 event-list">
          <div className="card card-1" data-aos="fade-right" style={{width: "18rem"}}>
            <img
          ...
          <div className="card card-2" data-aos="fade-up" style={{width: "18rem"}}>
            ...
            <div className="card-body">
              ...
              <a href="y" className="btn btn-light">Register</a>
            </div>
          </div>
